...
char name3[]="Prof. Bhanu";
char name4[]="Prof. Bhav";
char a1[]="Cycling";
...
char h4[]="PRESS E -> IMPACTS OF GREENHOUSE EFFECT";
...
//glClearColor(0.52734375,0.8046878,0.99765625,0.0);
glColor3f(1.0,1.0,1.0);
...
glClearColor(0.752,0.752,0.752,0.0);
...
print1(-.7,0.0,0.0,0.0,0.0,option4);
print1(-.7,-0.1,0.0,0.0,0.0,option3);
print1(-.7,-0.2,0.0,0.0,0.0,option5);

print1(-0.9,-.6,0.0,0.0,0.0,nm1);
print1(-0.9,-.7,0.0,0.0,0.0,name1);
print1(-0.9,-.8,0.0,0.0,0.0,name2);
print1(0.3,-.6,0.0,0.0,0.0,nm);
print1(0.3,-.7,0.0,0.0,0.0,name3);
print1(0.3,-.8,0.0,0.0,0.0,name4);
}
...
drawArrowIncoming(-.9+cx/2,.8+cy,1,0,0);
drawArrowIncoming(-.9+cx/5,.8+cy,1,0,0);
print(-.7,.7,0.0,0.0,0.0,text1);

}

else if(time4>13000 && time4<16500)
{
	drawArrowIncoming(-.9+cx,.8+cy,.603,.27,.603);
	print(-.5,-.4,0.0,0.0,0.0,text1);
}
